...
```{r}
# To run the default hashed_merge, this is all we have to do:
run_default_hashed_merge(left_dataset, right_dataset, left_name='Left dataset name', right_name='Right dataset name')
